...
class Admin_user_model extends CI_Model
{
	...
	function get_admin_user_data($params = array())
	{
		...
		if (!empty($params['search_for'])) {
			...
			$this->db->select("ft.*,cp.company_name,cp.company_unique_name,aur.name as admin_user_role_name, dm.name as designation_name , ci.name as city_name , s.name as state_name , c.name as country_name , c.short_name as country_short_name, c.dial_code ");

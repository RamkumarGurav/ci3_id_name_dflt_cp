...
if (!empty($admin_user_data)) {
	...
	$company_profile_id = $admin_user_data->company_profile_id;
						...
						<div class="card-body">
							...
							<div class="form-group row">
								<div class="col-lg-3 col-md-4 col-sm-6">
									<label for="inputEmail3" class="col-sm-12 label_content px-2 py-0">Company <span
											style="color:#f00;font-size: 22px;margin-top: 3px;">*</span></label>
									<div class="col-sm-12">
										<select type="text" class="form-control form-control-sm" required id="company_profile_id"
											name="company_profile_id">
											<option value="">Select Company</option>
											<?php foreach ($company_profile_data as $item) {
												$selected = "";
												if ($item->id == $company_profile_id) {
													$selected = "selected";
												}
												?>
												<option value="<?php echo $item->id ?>" <?php echo $selected ?>>
													<?php echo $item->company_unique_name ?>
								...
								<div class="col-lg-3 col-md-4 col-sm-6">
									<label for="inputEmail3" class="col-sm-12 label_content px-2 py-0">Role <span
											style="color:#f00;font-size: 22px;margin-top: 3px;">*</span></label>
									<div class="col-sm-12">
										<select type="text" class="form-control form-control-sm" required id="admin_user_role_id"
											name="admin_user_role_id">
											<option value="">Select Company</option>
											<?php foreach ($admin_user_role_data as $item) {
												$selected = "";
												if ($item->id == $admin_user_role_id) {
													$selected = "selected";
												}
												?>
												<option value="<?php echo $item->id ?>" <?php echo $selected ?>>

...
class Admin_user_module extends Main
{
	...
	function list()
	{
		...
		$this->data['company_profile_data'] = $this->Common_model->get_data(array('select' => '*', 'from' => 'company_profile', 'where' => "id > 0", "order_by" => "name ASC"));
	...
	function edit($id = "")
	{
		...
		$this->data['company_profile_data'] = $this->Common_model->get_data(array('select' => '*', 'from' => 'company_profile', 'where' => "id > 0", "order_by" => "company_unique_name ASC"));
	...
	function do_edit()
	{
		...
		if (
			...
			&& empty($_POST['company_profile_id']) && empty($_POST['designation_id']) && empty($_POST['admin_user_role_id']) && empty($_POST['address1'])
			&& empty($_POST['email'])
		...
		$enter_data['company_profile_id'] = $_POST['company_profile_id'];
